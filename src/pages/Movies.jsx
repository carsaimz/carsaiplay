...
const Movies = () => {
  ...
  const filteredMovies = movies
    .filter(movie => selectedCategory === 'all' || movie.category_ids?.includes(parseInt(selectedCategory)))
    .sort((a, b) => {
      switch (sortBy) {
        case 'rating':
  ...
  return (
    <div className="min-h-screen pt-8">
      <Helmet>
        <title>Filmes - CarsaiPlay</title>
        <meta name="description" content="Explore nossa coleção completa de filmes em alta qualidade. Encontre seus gêneros favoritos." />
      </Helmet>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl font-bold gradient-text mb-6">🎬 Filmes</h1>
        ...
        {loading ? (
          <div className="text-center py-12 text-white">Carregando filmes...</div>
        ) : (
          <ContentGrid
